...
var defaults = { 
    ...
    keyboardRadixChange:false,//是否允许用户改变键盘大小,该功能仅能完美支持Chrome26；仅当keyboardRadixMin不小于60时，完美支持Safari内核浏览器
...
this.each(function(){ 
  ...
  "</ul>");    
    ...
    var inputele = $(this).parent('span').prev('.numkeyboard');
    ...
    if(keytext==="关闭"||keytext.length<1){
